  ...
  <div class="app-container">
    <el-card>
      ...
      <div class="filter-container">
        ...
        <el-button v-waves :disabled="!checkPermission(['maidou.admin.create'])" class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">
          {{ '添加' }}
        </el-button>
      </div>
      ...
      >
        ...
        <el-table-column width="110px" align="center" :label="'授权'">
          <template slot-scope="scope">
            <el-button :disabled="!checkPermission(['maidou.admin.access'])" type="warning" size="mini" @click="handleAccess(scope.$index, scope.row)">
              授权
            </el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog :title="'添加账号'" :visible.sync="create.dialogVisible" @close="getList">
      <create :item="create" />
    </el-dialog>

    <el-dialog :title="'编辑账号'" :visible.sync="edit.dialogVisible" @close="getList">
      <edit :item="edit" />
    </el-dialog>
...
import { list, detail, del, modifyPassword } from '@/api/admin'
